...
export type ShareWhereInput = {
  ...
  permissions?: Prisma.StringFilter<"Share"> | string
...
export type ShareScalarWhereWithAggregatesInput = {
  ...
  permissions?: Prisma.StringWithAggregatesFilter<"Share"> | string
...
export type ShareOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "fileId" | "folderId" | "token" | "permissions" | "expiresAt" | "createdAt", ExtArgs["result"]["share"]>
...
export interface ShareFieldRefs {
  ...
  readonly permissions: Prisma.FieldRef<"Share", 'String'>
