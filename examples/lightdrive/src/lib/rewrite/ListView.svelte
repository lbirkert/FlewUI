<script lang="ts">
  ...
  let {
    ...
    selectedIds, sortMode = "date-desc",
    updateSort, sortIndicator,
  ...
  <div class="list-table">
    <div class="list-header">
      <button class="col-header" onclick={() => updateSort?.("name")}>
        Name{sortIndicator?.("name") === "asc" ? " ↑" : sortIndicator?.("name") === "desc" ? " ↓" : ""}
      </button>
      <button class="col-header col-size" onclick={() => updateSort?.("size")}>
        Size{sortIndicator?.("size") === "asc" ? " ↑" : sortIndicator?.("size") === "desc" ? " ↓" : ""}
      </button>
